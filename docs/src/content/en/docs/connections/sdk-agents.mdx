...
Coding agents without a dedicated Mastra package, such as Cline and OpenCode, run through the [Agent Client Protocol](/docs/connections/acp) instead.
