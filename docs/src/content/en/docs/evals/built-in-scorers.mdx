...
- [`multi-turn-judge`](/reference/evals/multi-turn-judge): Grades every assistant turn of a [multi-turn conversation](/docs/evals/multi-turn) against a plain-English criterion (`0` or `1`)
