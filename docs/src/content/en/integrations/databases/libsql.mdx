...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string',
    description:
      'URL of the remote primary database to sync from, enabling an embedded replica. Requires a local `file:` url.',
    isOptional: true,
  },
  {
    name: 'syncInterval',
    type: 'number',
    description: 'Interval in seconds for automatic sync with the remote primary. Only applies when `syncUrl` is set.',
    isOptional: true,
  },
]}
/>
