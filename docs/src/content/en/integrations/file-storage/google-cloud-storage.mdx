---
title: "Google Cloud Storage | File Storage"
...
See [E2BSandbox reference](/integrations/sandboxes/e2b) for more details on mounting.

## Related

- [WorkspaceFilesystem interface](/reference/workspace/filesystem)
- [ArchilFilesystem reference](/integrations/file-storage/archil)
