---
title: "Vercel Files | File Storage"
...
- **`deleteFile`** on a directory delegates to `rmdir({ recursive: true })`, matching the [`S3Filesystem`](/integrations/file-storage/amazon-s3) and [`GCSFilesystem`](/integrations/file-storage/google-cloud-storage) behavior.
