...
description: "API reference for SlackProvider, the managed Slack integration that creates Slack apps and handles OAuth before routing messages to agents."
packages:
  - "@mastra/slack"
---
...
- [Channels](/docs/channels): concepts, platform setup, and the `createSlackAdapter` path
