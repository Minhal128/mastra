...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'Reasoning file data',
    properties: [
      {
        type: 'ReasoningFilePayload',
        parameters: [
...
<PropertiesTable
  ...
  },
  {
    name: 'payload',
    type: 'CustomPayload',
    description: 'Custom provider content',
    properties: [
      {
        type: 'CustomPayload',
        parameters: [
          {
            name: 'kind',
            type: 'string',
            description: 'The kind of custom content, in the format `{provider}.{provider-type}`',
          },
          {
            name: 'providerMetadata',
            type: 'SharedV2ProviderMetadata',
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              'Epoch milliseconds captured immediately before the model provider call, so time to first token can be measured even when the chunk is delivered after streaming has begun',
          },
        ],
      },
    ],
