...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Object containing the new vector values, and optionally the metadata to update. The vector values are required',
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string[]',
    description:
      'Unique identifiers of the vectors to delete. Must contain at least one ID, and cannot be combined with filter',
  },
  {
    name: 'filter',
    type: 'Record<string, any>',
    isOptional: true,
    description: 'Not supported by Vectorize. Passing a filter throws an error',
  },
]}
/>
