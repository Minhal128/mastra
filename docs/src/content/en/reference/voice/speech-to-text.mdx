...
- [**OpenAI**](/integrations/voice/openai#voice): High-accuracy transcription with Whisper models
- [**Azure**](/integrations/voice/azure): Microsoft's speech recognition with enterprise-grade reliability
- [**ElevenLabs**](/integrations/voice/elevenlabs): Advanced speech recognition with support for multiple languages
- [**Google**](/integrations/voice/google#speech): Google's speech recognition with extensive language support
- [**Cloudflare**](/integrations/voice/cloudflare): Edge-optimized speech recognition for low-latency applications
- [**Deepgram**](/integrations/voice/deepgram): AI-powered speech recognition with high accuracy for multiple accents
