...
- [**OpenAI**](/integrations/voice/openai#voice): High-quality voices with natural intonation and expression
- [**Azure**](/integrations/voice/azure): Microsoft's speech service with voices and languages
- [**ElevenLabs**](/integrations/voice/elevenlabs): Ultra-realistic voices with emotion and fine-grained control
- [**Google**](/integrations/voice/google#speech): Google's speech synthesis with multilingual support
- [**Cloudflare**](/integrations/voice/cloudflare): Edge-optimized speech synthesis for low-latency applications
- [**Deepgram**](/integrations/voice/deepgram): AI-powered speech technology with high accuracy
- [**Speechify**](/integrations/voice/speechify): Text-to-speech optimized for readability and accessibility
- [**Sarvam**](/integrations/voice/sarvam): Specialized in Indic languages and accents
- [**Murf**](/integrations/voice/murf): Studio-quality voice overs with customizable parameters
...
For a broader overview of voice providers on agents, see [Voice in Mastra](/reference/voice/overview).
