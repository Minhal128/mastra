...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'Embedder',
    description:
      'Function that turns text into vectors. Required when `vectorStore` is set. Accepts either a single-text function `(text: string) => Promise<number[]>` or a batch-capable function `(texts: string[]) => Promise<number[][]>` that has a `batch: true` property and an optional `maxBatchSize`. See [Batch embedding](/docs/sandbox/search#batch-embedding).',
    isOptional: true,
  },
  {
    name: 'autoIndexPaths',
    ...
    properties: [
      {
        ...
        parameters: [
          {
            name: 'enabled',
            type: 'boolean | ((context: ToolConfigContext) => boolean | Promise<boolean>)',
            description: 'Default availability for all workspace tools. Per-tool settings take precedence.',
            isOptional: true,
            defaultValue: 'true',
          },
          {
            name: 'requireApproval',
            type: 'boolean | ((context: ToolConfigWithArgsContext) => boolean | Promise<boolean>)',
            description: 'Default approval policy for all workspace tools. Per-tool settings take precedence.',
            isOptional: true,
            defaultValue: 'false',
          },
          {
...
<PropertiesTable
  content={[
  {
    name: 'enabled',
    type: 'boolean | ((context: ToolConfigContext) => boolean | Promise<boolean>)',
    description: 'Whether the tool is available. Functions are evaluated when Mastra lists tools.',
    isOptional: true,
    defaultValue: 'true',
  },
  {
    name: 'requireApproval',
    type: 'boolean | ((context: ToolConfigWithArgsContext) => boolean | Promise<boolean>)',
    description: 'Whether the tool requires approval. Functions are evaluated when the tool executes.',
    isOptional: true,
    defaultValue: 'false',
  },
  {
    name: 'name',
    type: 'string',
    description: 'Name exposed to the model instead of the default `mastra_workspace_*` name.',
    isOptional: true,
  },
  {
    name: 'requireReadBeforeWrite',
    type: 'boolean | ((context: ToolConfigWithArgsContext) => boolean | Promise<boolean>)',
    description: 'For write tools, require the agent to read an existing file before changing it.',
    isOptional: true,
    defaultValue: 'false',
  },
  {
    ...
    type: 'number',
    description: 'Maximum output tokens for tools that support token-based truncation.',
    isOptional: true,
  },
]}
/>
...
See [Filesystem tools](/docs/sandbox/filesystem#using-mounts), [Sandbox tools](/docs/sandbox/overview#using-the-sandbox), [LSP inspection](/docs/sandbox/lsp#tool-name-remapping), and [Search tools](/docs/sandbox/search#agent-tools) for capability-specific configuration.
...
See [Background processes](/docs/sandbox/overview#background-processes) for callback examples.
