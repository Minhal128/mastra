...
- Fixed Tavily request attribution to use the X-Client-Name header. ([#19607](https://github.com/mastra-ai/mastra/pull/19607))
...
- dependencies updates: ([#17861](https://github.com/mastra-ai/mastra/pull/17861))
  - Updated dependency [`@tavily/core@^0.7.6` ↗︎](https://www.npmjs.com/package/@tavily/core/v/0.7.6) (from `^0.7.5`, in `dependencies`)

- dependencies updates: ([#17928](https://github.com/mastra-ai/mastra/pull/17928))
  - Updated dependency [`@tavily/core@^0.7.6` ↗︎](https://www.npmjs.com/package/@tavily/core/v/0.7.6) (from `^0.7.5`, in `dependencies`)
