...
describe('test-utils', () => {
  ...
  describe('readFixture', () => {
    ...
    it('should read .ts fixture when it exists', () => {
      ...
      expect(mockReadFileSync).toHaveBeenCalledWith(expect.stringContaining('test.input.ts'), 'utf8');
    });
    ...
    it('should read .tsx fixture when .ts does not exist', () => {
      ...
      expect(mockReadFileSync).toHaveBeenCalledWith(expect.stringContaining('test.input.tsx'), 'utf8');
    });
