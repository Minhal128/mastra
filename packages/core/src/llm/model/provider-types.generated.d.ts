...
export type ProviderModelsMap = {
  ...
  readonly 'zai-coding-plan': readonly ['glm-4.7', 'glm-5-turbo', 'glm-5.2', 'glm-5.2-highspeed', 'glm-5.3'];
  ...
  readonly modal: readonly ['moonshotai/Kimi-K3', 'thinkingmachines/Inkling-NVFP4'];
