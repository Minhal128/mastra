...
describe('AnswerRelevancyScorer', () => {
  ...
  it(
    ...
    async () => {
      ...
      const output = [createTestMessage({ role: 'assistant', content: testCases[0].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[1].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[1].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[2].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[2].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[3].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[3].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[5].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[5].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[6].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[6].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[7].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[7].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[8].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[8].output })];
  ...
  it(
    ...
    async () => {
      const inputMessages = [createTestMessage({ role: 'user', content: testCases[9].input })];
      const output = [createTestMessage({ role: 'assistant', content: testCases[9].output })];
