/**
 * VERBATIM COPY of packages/core/src/pulse/pricing.ts (branch
 * pulse/clickhouse-prototype) — the ONE cost rule. The viewer must show
 * only reader-derived values; if the branch file changes, re-copy this.
 */
/**
