...
const koaServerAdapter = new MastraServer({ mastra, app, openapiPath: '/openapi.json' });
await koaServerAdapter.init();
...
app.listen(PORT, () => {
  ...
  console.info(`OpenAPI spec: http://localhost:${PORT}/openapi.json`);
});
