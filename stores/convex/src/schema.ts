...
export const mastraObservationalMemoryTable = defineTable({
  ...
  observationBufferClaimToken: v.optional(v.union(v.string(), v.null())),
  observationBufferClaimAcquiredAt: v.optional(v.union(v.string(), v.null())),
  observationBufferClaimRenewedAt: v.optional(v.union(v.string(), v.null())),
  observationBufferClaimExpiresAt: v.optional(v.union(v.string(), v.null())),
  metadata: v.optional(v.union(v.string(), v.null())),
  createdAt: v.string(),
  updatedAt: v.string(),
})
