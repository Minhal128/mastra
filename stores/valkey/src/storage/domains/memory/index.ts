...
export class StoreMemoryValkey extends MemoryStorage {
  ...
  constructor(config: ValkeyDomainConfig) {
    super();
  ...
  public async getThreadById({
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'GET_THREAD_BY_ID', 'FAILED'),
  ...
  public async listThreads(args: StorageListThreadsInput): Promise<StorageListThreadsOutput> {
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_THREADS', 'INVALID_PAGE'),
          domain: ErrorDomain.STORAGE,
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_THREADS', 'INVALID_METADATA_KEY'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.USER,
    ...
    try {
      ...
      const mastraError = new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_THREADS', 'FAILED'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.THIRD_PARTY,
          details: {
  ...
  public async deleteThread({ threadId }: { threadId: string }): Promise<void> {
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'DELETE_THREAD', 'FAILED'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.THIRD_PARTY,
          details: {
            threadId,
  ...
  public async saveMessages(args: { messages: MastraDBMessage[] }): Promise<{ messages: MastraDBMessage[] }> {
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'SAVE_MESSAGES', 'INVALID_ARGS'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.USER,
        },
        error,
  ...
  public async listMessagesById({ messageIds }: { messageIds: string[] }): Promise<{ messages: MastraDBMessage[] }> {
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_MESSAGES_BY_ID', 'FAILED'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.THIRD_PARTY,
          details: {
  ...
  public async listMessages(args: StorageListMessagesInput): Promise<StorageListMessagesOutput> {
    ...
    if (threadIds.length === 0 || threadIds.some(id => !id.trim())) {
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_MESSAGES', 'INVALID_THREAD_ID'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.USER,
    ...
    try {
      if (page < 0) {
        throw new MastraError(
          {
            id: createStorageErrorId('VALKEY', 'LIST_MESSAGES', 'INVALID_PAGE'),
            domain: ErrorDomain.STORAGE,
            category: ErrorCategory.USER,
            details: { page },
          },
      ...
      const mastraError = new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'LIST_MESSAGES', 'FAILED'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.THIRD_PARTY,
          details: {
  ...
  public async cloneThread(args: StorageCloneThreadInput): Promise<StorageCloneThreadOutput> {
    ...
    if (!sourceThread) {
      throw new MastraError({
        id: createStorageErrorId('VALKEY', 'CLONE_THREAD', 'SOURCE_NOT_FOUND'),
        domain: ErrorDomain.STORAGE,
        category: ErrorCategory.USER,
    ...
    if (existingThread) {
      throw new MastraError({
        id: createStorageErrorId('VALKEY', 'CLONE_THREAD', 'THREAD_EXISTS'),
        domain: ErrorDomain.STORAGE,
        category: ErrorCategory.USER,
    ...
    try {
      ...
      throw new MastraError(
        {
          id: createStorageErrorId('VALKEY', 'CLONE_THREAD', 'FAILED'),
          domain: ErrorDomain.STORAGE,
          category: ErrorCategory.THIRD_PARTY,
