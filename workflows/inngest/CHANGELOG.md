...
- Fix durable agents losing the caller's request context after the first iteration. ([#21125](https://github.com/mastra-ai/mastra/pull/21125))
...
- Fixed Inngest TypeScript build failures for workflows whose steps use typed request context. ([#19225](https://github.com/mastra-ai/mastra/pull/19225))

- Fixed nested Inngest workflows to resume the suspended child step when only the parent workflow step is provided. ([#19752](https://github.com/mastra-ai/mastra/pull/19752))
...
- dependencies updates: ([#17850](https://github.com/mastra-ai/mastra/pull/17850))
  - Updated dependency [`inngest@^4.5.0` ↗︎](https://www.npmjs.com/package/inngest/v/4.5.0) (from `^4.2.2`, in `dependencies`)
